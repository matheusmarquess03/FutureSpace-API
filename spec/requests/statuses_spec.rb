...
RSpec.describe "/statuses", type: :request do
  ...
  # StatusesController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get statuses_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Status" do
        expect {
          post statuses_url,
               params: { status: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Status" do
        expect {
          post statuses_url,
               params: { status: invalid_attributes }, as: :json
        }.to change(Status, :count).by(0)
      end

      it "renders a JSON response with errors for the new status" do
        post statuses_url,
             params: { status: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested status" do
        status = Status.create! valid_attributes
        patch status_url(status),
              params: { status: new_attributes }, headers: valid_headers, as: :json
        status.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested status" do
      status = Status.create! valid_attributes
      expect {
        delete status_url(status), headers: valid_headers, as: :json
      }.to change(Status, :count).by(-1)
    end
  end
end
